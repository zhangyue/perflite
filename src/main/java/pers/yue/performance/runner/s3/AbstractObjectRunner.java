...
import pers.yue.performance.runner.AbstractPerfRunner;
...
public abstract class AbstractObjectRunner extends AbstractPerfRunner implements Runnable, PerfRunner {
    ...
    protected static final ThreadLocal<byte[]> downloadBuffer = ThreadLocal.withInitial(() -> new byte[(int) FileUtil.ByteUnit.MB * 1]);
